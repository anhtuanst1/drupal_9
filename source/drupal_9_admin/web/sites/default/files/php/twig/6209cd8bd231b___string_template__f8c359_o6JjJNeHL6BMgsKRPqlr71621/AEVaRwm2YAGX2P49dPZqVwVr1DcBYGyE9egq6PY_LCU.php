...
/* __string_template__f8c359431fc6cba09baa16fe766a3da6 */
class __TwigTemplate_0028aa86cce8046ff0e77b2b20616efb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
            ...
            // line 19
            echo "  ";
            (((twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "getUsername", [], "any", true, true, true, 19) &&  !(null === twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "getUsername", [], "any", false, false, true, 19)))) ? (print ($this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "getUsername", [], "any", false, false, true, 19), "html", null, true))) : (print ("aaa")));
            echo " - ";
            (((twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "id", [], "any", true, true, true, 19) &&  !(null === twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "id", [], "any", false, false, true, 19)))) ? (print ($this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "id", [], "any", false, false, true, 19), "html", null, true))) : (print ("bbb")));
            echo "
";
        }
        // line 21
...
<p><a href=@ajax_wizard_example_nojs>AJAX Wizard Example w/JS turned off</a></p>", array("@simple_ajax_example" =>         // line 25
($context["simple_ajax_example"] ?? null), "@ajax_generate_textfields" =>         // line 26
($context["ajax_generate_textfields"] ?? null), "@ajax_submit" =>         // line 27
($context["ajax_submit"] ?? null), "@ajax_dependent_dropdown" =>         // line 28
($context["ajax_dependent_dropdown"] ?? null), "@ajax_dependent_dropdown_nojs" =>         // line 29
($context["ajax_dependent_dropdown_nojs"] ?? null), "@ajax_dynamic_form" =>         // line 30
($context["ajax_dynamic_form"] ?? null), "@ajax_dynamic_form_nojs" =>         // line 31
($context["ajax_dynamic_form_nojs"] ?? null), "@ajax_wizard_example" =>         // line 32
($context["ajax_wizard_example"] ?? null), "@ajax_wizard_example_nojs" =>         // line 33
($context["ajax_wizard_example_nojs"] ?? null), ));
    }

    public function getTemplateName()
    {
        return "__string_template__f8c359431fc6cba09baa16fe766a3da6";
    }
    ...
    {
        return array (  99 => 33,  98 => 32,  97 => 31,  96 => 30,  95 => 29,  94 => 28,  93 => 27,  92 => 26,  91 => 25,  81 => 22,  78 => 21,  70 => 19,  62 => 17,  60 => 16,  58 => 15,  56 => 14,  54 => 13,  52 => 12,  50 => 11,  48 => 10,  46 => 9,  44 => 8,  42 => 7,  39 => 6,);
    }

    public function getSourceContext()
    {
        return new Source("", "__string_template__f8c359431fc6cba09baa16fe766a3da6", "");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 7, "if" => 16, "trans" => 22);
